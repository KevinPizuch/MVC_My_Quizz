...
// Returns the private 'App\Repository\ReponsesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ReponsesRepository.php';

return $this->privates['App\\Repository\\ReponsesRepository'] = new \App\Repository\ReponsesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
