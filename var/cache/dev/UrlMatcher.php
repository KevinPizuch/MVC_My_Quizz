...
return [
    ...
    [ // $dynamicRoutes
        ...
        188 => [[['_route' => 'categorie', '_controller' => 'App\\Controller\\HomeController::show'], ['id'], null, null, false, true, null]],
        235 => [[['_route' => 'product_show', '_controller' => 'App\\Controller\\QuestionsController::questions'], ['name', 'questionsNbr', 'questionIndex', 'id'], null, null, false, true, null]],
        258 => [[['_route' => 'k', '_controller' => 'App\\Controller\\QuestionsController::check'], ['name', 'questionsNbr', 'questionIndex', 'id', 'questionId'], null, null, false, true, null]],
        296 => [[['_route' => 'fos_user_registration_confirm', '_controller' => 'fos_user.registration.controller:confirmAction'], ['token'], ['GET' => 0], null, false, true, null]],
        326 => [
