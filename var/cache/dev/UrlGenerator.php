...
return [
    ...
    'categorie' => [['id'], ['_controller' => 'App\\Controller\\HomeController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/categorie']], [], []],
    'product_show' => [['name', 'questionsNbr', 'questionIndex', 'id'], ['_controller' => 'App\\Controller\\QuestionsController::questions'], [], [['variable', '/', '[^/]++', 'id', true], ['variable', '/', '[^/]++', 'questionIndex', true], ['variable', '/', '[^/]++', 'questionsNbr', true], ['variable', '/', '[^/]++', 'name', true]], [], []],
    'k' => [['name', 'questionsNbr', 'questionIndex', 'id', 'questionId'], ['_controller' => 'App\\Controller\\QuestionsController::check'], [], [['variable', '/', '[^/]++', 'questionId', true], ['text', '/check'], ['variable', '/', '[^/]++', 'id', true], ['variable', '/', '[^/]++', 'questionIndex', true], ['variable', '/', '[^/]++', 'questionsNbr', true], ['variable', '/', '[^/]++', 'name', true]], [], []],
