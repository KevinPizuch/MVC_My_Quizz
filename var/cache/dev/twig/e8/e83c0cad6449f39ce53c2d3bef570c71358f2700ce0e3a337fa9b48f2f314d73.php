...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "SwiftmailerBundle:Collector:swiftmailer.html.twig", "/home/ryzz/MVC_My_Quiz/MVC_My_Quiz/vendor/symfony/swiftmailer-bundle/Resources/views/Collector/swiftmailer.html.twig");
    }
}
